...
of Things (IoT). Unfortunately, the existing operating systems commonly used in this
...
RIOT OS on the MSP430 microcontroller, an architecture widely used in IoT-enabled
...
(microcontroller) can offer. We then demonstrate the effectiveness  of these features
...
of our own designs, and obtained very promising results, shown in the next section.
