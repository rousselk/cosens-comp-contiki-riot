...
\texttt{rtimer} mechanism is a ``paradigm breake''.
Only functions that run with all interrupts disabled (like
...
\begin{figure*}[ptb]
\centering
\includegraphics[width=15.5cm]{S-CoSenS-Cooja10.png}
\caption{Screenshot of our test simulation in Cooja.\\
(This screenshot show ``Cooja: The Contiki Network Simulator'' running
 our RIOT test application, despite the window title)}
\label{Screenshot}
\end{figure*}
