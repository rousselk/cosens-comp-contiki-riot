...
\end{itemize}
None of the established OSes commonly used either in the IoT domain (TinyOS,
Contiki) nor in the larger spectrum of RTOS (FreeRTOS) could match our needs.
...
versions were not stable enough to make real use of the platform, and there
was absolutely no work related to the MAC~/ RDC layer had been done
